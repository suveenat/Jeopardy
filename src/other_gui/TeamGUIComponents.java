...
public class TeamGUIComponents extends TeamData{
	...
	public void prepareForFinalJeopardy(NetworkFJG gui, GameData gameData){
		initializeBetSlider();
		addNetworkedActionListeners(gui, gameData);
	}
	...
	private void addNetworkedActionListeners(NetworkFJG finalJeopardyGUI, GameData gameData){
		//slider change listener, set member variable to anonymous class
		fjBetSliderChangeListener = new ChangeListener(){
